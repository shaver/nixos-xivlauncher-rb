...
{
  inputs = {
    nixpkgs.url = "github:NixOS/nixpkgs/nixos-25.11"; # This should match the version of NixOS you want to use
...
* [drakon64](https://github.com/drakon64) for the first incarnation of this flake
